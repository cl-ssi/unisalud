...
class DependentUserImport implements ToModel, WithHeadingRow//, WithValidation
{
    ...
    */
    public function model(array $row)
    {
        ...
        $headings = [
            'establecimiento', 'nombre', 'apellido_paterno', 'apellido_materno', 'run',
            'prevision', 'sexo', 'genero', 'fecha_nacimiento', 'nacionalidad',
            'comuna', 'calle', 'departamento', 'diagnostico', 'fecha_ingreso',
            'fecha_egreso', 'visitas_integrales', 'visitas_tratamiento', 'emp_empam',
            'eleam', 'upp', 'plan_elaborado', 'plan_evaluado', 'neumo', 'influenza',
            'covid_19', 'extra_info', 'ayuda_tecnica', 'ayuda_tecnica_fecha',
            'entrega_alimentacion', 'entrega_alimentacion_fecha', 'sonda_sng',
            'sonda_urinaria', 'prevision_cuidador', 'talla_panal', 'nombre_cuidador',
            'apellido_paterno_cuidador', 'apellido_materno_cuidador',
            'fecha_nacimiento_cuidador', 'run_cuidador', 'dv_cuidador', 'sexo_cuidador',
            'genero_cuidador', 'nacionalidad_cuidador', 'parentesco_cuidador',
            'empam_cuidador'
        ];
    ...
    public function formatField($value, $type)
    {
        switch ($type) {
            case 'boolean':
                ...
                return $value == 'si' || $value == 'ok' ? true : 
                       ($value == 'no' || $value == 'p' ? false : null);
